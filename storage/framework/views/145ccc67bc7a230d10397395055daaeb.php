    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse justify-content-end gap-4" id="navbarSupportedContect">
            <ul class="navbar-nav gap-4>
                <li class=" nav-item">
                <a class="nav-link <?php echo e(Request::path() == '/' ? 'active' : ''); ?>" aria-current="page" href="/">Beranda</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php echo e(Request::path() == 'kategori' ? 'active' : ''); ?>" href="/kategori">Kategori</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php echo e(Request::path() == 'contact' ? 'active' : ''); ?>" href="/contact">Contact Us</a>
                </li>
            </ul>
...
</nav><?php /**PATH /Users/azkanra/toko_kazayya/resources/views/pelanggan/component/navbar.blade.php ENDPATH**/ ?>